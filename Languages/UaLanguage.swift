...
class UaLanguage : LanguageProtocol {
    ...
    var numbersToTwenty: [Int : String]
    var ordinalToTwenty: [Int : String]
    var tens: [Int : String]
    var numbersForComplexOrdinal: [Int : String]
    ...
    private init() {
        ...
        numberParts = NumberParts(number: 0)
    }
